  ...
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-slate-950 via-purple-950/10 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Follow Me Section - Full Width Below Grid */}
        <motion.div
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">Follow Me</h3>
            <p className="text-slate-400 text-sm md:text-base">Connect with me on social media</p>
          </div>
