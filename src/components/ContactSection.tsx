    ...
    <section id="contact" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-slate-950 via-purple-950/10 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 md:gap-16 mb-16 items-start">
          {/* Contact Info Section - Hidden on mobile, visible on lg */}
          <motion.div
            className="flex-col space-y-6 hidden lg:flex"
          ...
          >
            ...
            {/* Follow Me Section - Desktop only */}
            <motion.div
            ...
            >
              <h4 className="text-lg sm:text-xl font-semibold text-slate-100 mb-6">Follow Me</h4>
              <div className="flex gap-4 flex-wrap">
                {[
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.953 4.57a10 10 0 002.856-9.86 9.958 9.958 0 01-2.821.856 4.958 4.958 0 00-8.593 4.516 14.025 14.025 0 01-10.177-5.116 4.93 4.93 0 001.532 6.573 4.902 4.902 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                      </svg>
                    ),
                    bgColor: 'bg-cyan-900 hover:bg-cyan-800',
                    textColor: 'text-cyan-300 hover:text-cyan-100',
                  },
                  {
                    label: 'Facebook',
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-4 rounded-lg ${social.bgColor} border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 flex items-center justify-center ${social.textColor}`}
                    title={social.label}
        ...
        {/* Follow Me Section - Appears below form on mobile */}
        <motion.div
          ...
          transition={{ duration: 0.6, delay: 0.3 }}
        >
          <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-slate-100 mb-8 mt-12">Follow Me</h3>
