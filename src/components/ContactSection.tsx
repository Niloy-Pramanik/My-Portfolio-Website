...
export function ContactSection() {
  return (
    <section id="contact" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-slate-950 via-purple-950/10 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-slate-100 mb-8">Contact Information</h3>
          ...
          <motion.form
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-2xl md:text-3xl font-bold text-slate-100 mb-8">Send Message</h3>
