...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { 
      label: 'LinkedIn', 
      url: 'https://www.linkedin.com/in/niloy-pramanik-01a638233/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3ByTQr1qaDQp2IWObkOqLf0A%3D%3D',
